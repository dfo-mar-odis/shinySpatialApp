...
```{r totalNitroLoad-plot, fig.height=7, fig.width=11, fig.show="hold", out.width="50%", fig.cap=paste(write_caption_blurb(totalNitroLoad_rr, "EN"), 'Map showing Total_Nitrogen_Load,Total Nitrogen load (kg N/yr). Calculated in: [@nitroLoad_pub] ')}
