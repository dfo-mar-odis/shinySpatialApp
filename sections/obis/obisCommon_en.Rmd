...
The Basis of Record field (i.e., column name) specifies the nature of
...
The following cases were displayed separately from those above because
they contain aggregated location information:

-   MachineObservation: observations are derived from machine or
    computer-based detections such as automated sensors (e.g., DNA
    sequencers) or image recognition. For the Scotian Shelf Bioregion,
    Machine Observations only include satellite telemetry records of
    humpback whales. Observations are reported when tagged whales when
    they come to the surface to breathe, and are aggregated within a
    1-degree cell. There are currently no Machine Observation records
    for fish or invertebrate species in this region.
