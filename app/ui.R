    ...
    sidebarPanel(
      ...
      tabsetPanel(
        ...
        tabPanel(
          ...
          selectInput("u_region", label = "Indicate for which Region you are generating this report",
          ...
          br(),
          actionButton("get_u_details", 'Validate', icon =icon("check")),
          hspace(2),
          uiOutput("valid_details", inline = TRUE)
        ),

        # VIEW MAP & SELECT GEOMETRIES
        tabPanel(
          "View map",
          icon = icon("map"),
