...
wsdbClipped <- master_intersect(wsdb_sf, mapDataList)
...
if (!is.null(wsdbClipped$studyData)) {
  plot_rr_sf(areaMap, wsdbClipped$mapData, attribute="Legend", colorMap = whaleCol, shapeMap = whaleShape)
}
```
...
whiteheadClipped <- master_intersect(whitehead_sf, mapDataList)
...
if (!is.null(whiteheadClipped$studyData)) {
  plot_rr_sf(areaMap, whiteheadClipped$mapData, attribute="Legend", colorMap = whaleCol, shapeMap = whaleShape)
}
```
...
narwcClipped <- master_intersect(narwc_sf, mapDataList)
...
if (!is.null(narwcClipped$studyData)) {
   plot_rr_sf(areaMap, narwcClipped$mapData, attribute="Legend", colorMap = whaleCol, shapeMap = whaleShape)
}
```
...
obisClipped <- master_intersect(obis_cet_sf, mapDataList)
...
if (!is.null(obisClipped$studyData)) {
  plot_rr_sf(areaMap, obisClipped$mapData, attribute="Legend", colorMap = whaleCol, shapeMap = whaleShape)
}
```
