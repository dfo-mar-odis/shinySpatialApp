...
outputList <- main_intersect(wsdb_sf, studyArea, mapBbox = bboxMap)
...
outputList <- main_intersect(whitehead_sf, studyArea, mapBbox = bboxMap)
if (!is.null(outputList)) {
...
outputList <- main_intersect(narwc_sf, studyArea, mapBbox = bboxMap)
...
outputList <- main_intersect(obis_cet_sf, studyArea, mapBbox = bboxMap)
...
polyText<-if(is.null(clipped$studyPoly)){"La zone de recherche ne chevauche pas l’habitat important des rorquals bleus dans l’ouest de l’Atlantique-Nord."
...
<<<<<<< HEAD
#### ***Résultats de la recherche sur l’habitat important pour la baleine à bec commune, par zone***
=======
...
>>>>>>> 8d5588be5459dec14288036f9a824a15422e42af
*
...
polyText<-if(is.null(clipped$studyPoly)){"La zone de recherche ne chevauche pas l’habitat important pour la baleine à bec commune dans les zones situées entre les canyons de l’est du plateau néo-écossais."
