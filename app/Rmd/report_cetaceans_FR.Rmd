...
Une recherche du SIBO a été effectuée pour trouver d’autres documents pertinents pour les cétacés inscrits en vertu de la LEP, évalués par le COSEPAC ou inclus dans la liste des espèces sauvages. Un processus de CQ de premier niveau a été effectué en supprimant les rapports en double qui sont également présents dans la BDOB. Les versions subséquentes de ce rapport viseront à étendre nos efforts de CQ pour cette source d’information.
...
### **Habitat important pour la baleine à bec commune**  
...
Consulté le : 17 juin 2021 sur le Portail de données ouvertes <https://ouvert.canada.ca/data/fr/dataset/9fd7d004-970c-11eb-a2f3-1860247f53e3>      
Niveau de qualité : Élevée   
Niveau de sécurité : Aucun  
