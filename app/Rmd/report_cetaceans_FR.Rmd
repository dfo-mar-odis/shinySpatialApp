...
outputList <- master_intersect(wsdb_sf, region, studyArea, mapBbox = bboxMap)
...
outputList <- master_intersect(whitehead_sf, region, studyArea, mapBbox = bboxMap)
if (!is.null(outputList)) {
...
outputList <- master_intersect(narwc_sf, region, studyArea, mapBbox = bboxMap)
...
outputList <- master_intersect(obis_cet_sf, region, studyArea, mapBbox = bboxMap)
