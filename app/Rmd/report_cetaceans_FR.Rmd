...
filesLoaded <- load_rdata(c("wsdb_rr", "whitehead_rr"), "MAR", env = environment())
...
```
Année de recherche : de 2010 à 2020  
...
```
Année de recherche : de 2010 à 2019  
