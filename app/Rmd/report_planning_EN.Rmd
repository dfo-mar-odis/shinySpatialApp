...
```{r EBSA-area-plot, fig.height=8, fig.width=11, fig.cap=paste(write_caption_blurb(ebsa_rr, "EN"), 'Map showing Ecologically and Biologically Significant Areas (EBSA) in the search area defined by the user (red outline).')}
