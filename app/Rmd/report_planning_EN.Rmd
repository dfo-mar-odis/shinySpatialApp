...
load_rdata(c("ebsa_rr"), "MAR", env = environment())
```
...
```{r EBSA-area-plot, fig.height=8, fig.width=11, fig.cap= 'Quality tier: High. Security level: none. Map showing Ecologically and Biologically Significant Areas (EBSA) in the search area (red outline).'}
