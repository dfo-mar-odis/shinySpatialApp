...
if (!is.null(mpaClipped$regionData)){
  ...
  mpaPlotList <- plot_rr_sf(regionMap, mpaClipped$regionData, mpa_rr$attribute, getColorMap=TRUE,
...
if(!is.null(mpaClipped$studyData)){
  ...
  plot_rr_sf(areaMap, mpaClipped$studyData, mpa_rr$attribute, colorMap = mpaPlotList$colorMap,
