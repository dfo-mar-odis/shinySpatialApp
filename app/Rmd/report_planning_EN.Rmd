...
if (!is.null(mpaTable)) {
  knitr::kable(mpaTable, align="l", caption=paste(write_caption_blurb(ebsa_rr, "EN"), "Area and names of spatial conservation areas that overlap the search area.</b>"), booktabs = T, escape = F, linesep="") %>% kable_styling(bootstrap_options = "striped", full_width = F, position = "left")
}
```
