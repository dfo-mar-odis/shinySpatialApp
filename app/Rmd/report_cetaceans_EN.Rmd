...
```{r child = here::here("app/Rmd/sections/wsdb.Rmd")}
```

```{r child = here::here("app/Rmd/sections/whitehead.Rmd")}
```

```{r child = here::here("app/Rmd/sections/narwc.Rmd")}
```

```{r child = here::here("app/Rmd/sections/obisCet.Rmd")}
```
...
```{r child = here::here("app/Rmd/sections/sdm.Rmd")}
```

```{r child = here::here("app/Rmd/sections/blueWhaleHab.Rmd")}
```

```{r child = here::here("app/Rmd/sections/nbw.Rmd")}
```
