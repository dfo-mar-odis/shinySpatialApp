...
if (!is.null(wsdbClipped$studyData)) {
  whaleSummaryTable <- add_col_to_whale_summary(whaleSummaryTable, "WSDB", wsdbClipped$studyData, "Legend")
  summarySarTable <- add_col_to_sar_summary(summarySarTable, "WSDB", whaleSummaryTable, "specIndex", "WSDB")
} else {
 summarySarTable <- add_col_to_sar_summary(summarySarTable, "WSDB", NULL, "specIndex", "WSDB")
}
```
*
...
if (!is.null(whiteheadClipped$studyData)) {
  whaleSummaryTable <- add_col_to_whale_summary(whaleSummaryTable, "Whitehead", whiteheadClipped$studyData, "Legend")
  summarySarTable <- add_col_to_sar_summary(summarySarTable, "Whitehead", whaleSummaryTable, "specIndex", "Whitehead")
} else {
 summarySarTable <- add_col_to_sar_summary(summarySarTable, "Whitehead", NULL, "specIndex", "Whitehead")
}
```
*
...
if (!is.null(narwcClipped$studyData)) {
  whaleSummaryTable <- add_col_to_whale_summary(whaleSummaryTable, "NARWC", narwcClipped$studyData, "Legend")
  summarySarTable <- add_col_to_sar_summary(summarySarTable, "NARWC", whaleSummaryTable, "specIndex", "NARWC")
 } else {
   summarySarTable <- add_col_to_sar_summary(summarySarTable, "NARWC", NULL, "specIndex", "NARWC")
 }
...
if (!is.null(obisClipped$studyData)) {
  whaleSummaryTable <- add_col_to_whale_summary(whaleSummaryTable, "OBIS", obisClipped$studyData, "Legend")
  summarySarTable <- add_col_to_sar_summary(summarySarTable, "OBIS-Cetaceans", whaleSummaryTable, "specIndex", "OBIS")
 } else {
   summarySarTable <- add_col_to_sar_summary(summarySarTable, "OBIS-Cetaceans", NULL, "specIndex", "OBIS")
 }
