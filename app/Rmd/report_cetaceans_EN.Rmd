...
whale_col <- c("Beluga Whale: Endangered (SARA & COSEWIC)"="cyan3",
               "Blue Whale: Endangered (SARA & COSEWIC)"="black", 
               "Fin Whale: Special Concern (SARA & COSEWIC)"="chartreuse4",
               "Harbour Porpoise: Threatened (SARA) Special Concern (COSEWIC)"="red",
...
if (!is.null(outputList$studyData)) {
  plot_rr_sf(areaMap, wsdb_points, attribute="Legend", colorMap = whale_col, diffShapes=TRUE)
}
```
