...
outputList <- point_intersect(wsdb_sf, studyArea, Bbox = bboxMap)
...
outputList <- point_intersect(whitehead_sf, studyArea, Bbox = bboxMap)
if (!is.null(outputList)) {
...
outputList <- point_intersect(narwc_sf, studyArea, Bbox = bboxMap)
...
outputList <- point_intersect(obis_cet_sf, studyArea, Bbox = bboxMap)
