...
Contact: [XMARWhaleSightings\@dfo-mpo.gc.ca](mailto:XMARWhaleSightings@dfo-mpo.gc.ca){.email} URL: <http://www.inter.dfo-mpo.gc.ca/Maritimes/SABS/popec/sara/Database>\
...
Contact: [hpettis\@neaq.org](mailto:hpettis@neaq.org){.email}\
...
Contact: [helpdesk\@obis.org](mailto:helpdesk@obis.org){.email}\
URL: <https://obis.org/>\
