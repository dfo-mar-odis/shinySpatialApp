...
whale_col=values=c("Blue Whale: Endangered (SARA & COSEWIC)"="black",
                   ...
                   "Harbour Porpoise: Threatened (SARA) Special Concern   (COSEWIC)"="gray",
...
wsdb_plot <- site_map(studyArea,site,land50k_sf,5, bounds_sf)+
  geom_point(data = wsdb_intersect_points, aes(x = long, y = lat, color=CommonName_status), size = 2, shape = 20)+
...
whitehead_plot <- site_map(studyArea,site,land50k_sf,5,bounds_sf)+
  geom_point(data = whitehead_intersect_points, aes(x = long, y = lat, color=CommonName_status), size = 2, shape = 20)+
  theme(legend.text=element_text(size=rel(0.9)))
...
narwc_plot<-site_map(studyArea,site,land50k_sf,5, bounds_sf)+
  geom_point(data = narwc_intersect_points, aes(x = long, y = lat, color=CommonName_status), size = 2, shape = 20)+
  theme(legend.text=element_text(size=rel(0.9)))
...
obis_plot<-site_map(studyArea,site,land50k_sf,5,bounds_sf)+
  geom_point(data = obis_intersect_points_cet, aes(x = long, y = lat, color=CommonName_status), size = 2, shape = 20)+
  theme(legend.text=element_text(size=rel(0.9)))
