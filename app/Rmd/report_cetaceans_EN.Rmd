...
areaMapBW <- areaMap+
           geom_sf(data=outputList$mapPoly,fill="red",col="black")
regionMapBW <- regionMap+
             geom_sf(data=outputList$regionPoly,fill="red",col="black")
```
...
# the scales::alpha argument can make the polygon colour transparent
areaMapNBNW <- areaMap+
           geom_sf(data=outputList$mapPoly,fill=scales::alpha("red",0.5),col="black")
