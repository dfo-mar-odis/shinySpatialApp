...
# plotted with colour
outputListCrithab <- master_intersect(ClippedCritHab_sf, mapDataList, getRegion=TRUE)
...
if (!is.null(outputListCrithab$regionData)){
  plot_rr_sf(regionMap, outputListCrithab$regionData, attributeCrithab, legendName = legendNameCrithab)
}    
```
<br>
...
if (!is.null(outputListCrithab$mapData)){
  plot_rr_sf(areaMap, outputListCrithab$mapData, attributeCrithab, legendName = legendNameCrithab)
}  
```
<br>
