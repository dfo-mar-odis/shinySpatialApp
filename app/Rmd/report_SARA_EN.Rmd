...
if (!is.null(outputListSardist$studyData)){
  ...
  summaryHabTable <- add_col_to_sar_summary(summaryHabTable, "range", distTable, "Common Name", "Common Name")
} else {
  summaryHabTable <- add_col_to_sar_summary(summaryHabTable, "range", NULL, "Common Name", "Common Name")
}
```
*
