...
#rockweed_plot<-plot_rockweed(rockweed_sf, studyArea, land50k_sf, 5, bounds_sf)
#if(rockweed_result > 1){print(rockweed_plot)} else {NULL}
# rwMap<-plot_rockweed(rockweed_sf, areaMap, bboxMap)
# if(rwMap > 1){print(rockweed_plot)} else {NULL}
```