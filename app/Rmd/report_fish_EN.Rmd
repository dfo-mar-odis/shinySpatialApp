...
ocearchOutputList <- master_intersect(ocearch_sf, region, studyArea, mapBbox = bboxMap, Year = minYear)
...
if (!is.null(ocearchOutputList)) {
  areaMap +
    geom_point(data = ocearchOutputList$mapPoints, aes(x = long, y = lat), size = 2, shape = 16, col = "black")
}
```
