...
if (!is.null(outputList$studyData)) {
  ...
  summarySarTable <- add_col_to_sar_summary(summarySarTable, "[RV](#RV-section)", rvSarTable, "Common Name", "Individuals")
    ...
    summarySarTable <- add_col_to_sar_summary(summarySarTable, "[RV](#RV-section)", outputList$studyData, "Common Name", "Individuals")
}
...
if (!is.null(outputListI$studyData)) {
  ...
  summarySarTable <- add_col_to_sar_summary(summarySarTable, "[ISDB](#ISDB-section)", NULL, "Common Name", "Records")
}
...
if (!is.null(outputListM$studyData)) {
  ...
  summarySarTable <- add_col_to_sar_summary(summarySarTable, "[MARFIS](#MARFIS-section)", NULL, "Common Name", "Records")
}
```
*
...
if (!is.null(outputList$studyData)) {
  ...
  summarySarTable <- add_col_to_sar_summary(summarySarTable, "[OBIS](#OBIS-section)", NULL, "Common Name", "Common Name")
}
```
*
...
ocearchOutputList <- master_intersect(ocearch_sf, mapDataList)
 ...
 if (!is.null(ocearchOutputList$studyData)) {
   ...
   summarySarTable <- add_col_to_sar_summary(summarySarTable, "[OCEARCH](#OCEARCH-section)", ocearchSummaryRow, "CommonName", "CommonName")
 } else {
   summarySarTable <- add_col_to_sar_summary(summarySarTable, "[OCEARCH](#OCEARCH-section)", NULL, "CommonName", "CommonName")
 }
