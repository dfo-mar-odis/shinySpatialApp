...
outputList <- master_intersect(ocearch_sf, region, studyArea, mapBbox = bboxMap, Year = minYear)
Samples_bbox <- outputList$mapPoints
...
Report_ocearch <- if (is.null(outputList)) {
  "There are no relevant White Shark records in the OCEARCH Shark Tracker for this search area."
} else {
  "There are relevant White Shark records in OCEARCH Shark Tracker search results for this search area."
}
