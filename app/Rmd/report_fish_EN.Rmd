...
```{r new-marfis-isdb-results, include=FALSE, cache=FALSE}
...
```{r new-isdb-check, comment="", prompt=TRUE, echo=FALSE, results='asis'}
...
```{r new-marfis-check, comment="", prompt=TRUE, echo=FALSE, results='asis'}
