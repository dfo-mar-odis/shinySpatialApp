...
```{r ef-plot, fig.height=7, fig.width=11, fig.cap=paste(write_caption_blurb(ef_rr, "EN"), 'Electrofishing survey records observed within the search area defined by the user (red outline). Numbers refer to the Watershed Labels mentioned in the Table below. Some sites were surveyed in multiple years.')}
if (!is.null(efOutputList$studyData)) {
