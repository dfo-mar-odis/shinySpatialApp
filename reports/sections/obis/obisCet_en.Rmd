...
```{r cet-short-obis, results = 'asis', eval=!obisEnv$commonObis}
...
reportGbif <-  if (is.null(gbifClipped$studyData)) {
  "*	There no are relevant records in the Global Biodiversity Information Facility (GBIF) for this search area."
