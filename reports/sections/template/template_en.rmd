...
# summary intro table
introResult <- !is.null(templateOutputList$studyData)
summaryIntroTable <- add_row_to_intro_summary(summaryIntroTable, name="[Template](#teplate-section)", result=introResult)
