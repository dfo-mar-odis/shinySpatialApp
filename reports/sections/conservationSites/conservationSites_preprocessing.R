...
if (globalControlEnv$updateGeoms) {
  ...
  conservationSites_sf <- conservationSites_rr$data_sf
}
...
save(conservationSites_rr, file = file.path(get_file_save_path(globalControlEnv$saveToRemote), "Secure/conservationSites_rr.RData"))
