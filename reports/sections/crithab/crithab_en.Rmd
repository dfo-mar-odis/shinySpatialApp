...
```
<br>
```{r crithab-area-plot, fig.height=7, fig.width=11, fig.cap=paste(write_caption_blurb(crithab_rr, "EN"), 'Critical habitat of Species at Risk, listed as Endangered or Threatened under the <i>Species at Risk Act</i> (SARA), located within the search area (red outline)')}
