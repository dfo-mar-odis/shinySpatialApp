...
# summary intro table
introResult <- !is.null(powerOutputList$studyData)
summaryIntroTable <- add_row_to_intro_summary(summaryIntroTable, name="[Power Stations](#power-section)", result=introResult)
