...
```
<br>
```{r benthicEffort-region-plot, fig.height=7, fig.width=11, fig.cap=paste(write_caption_blurb(benthicEffort_rr, "EN"), 'Maps showing the benthic fishing effort with the search area (red outline).')}
...
```{r benthicEffort-area-plot, fig.height=7, fig.width=11, fig.cap=paste(write_caption_blurb(benthicEffort_rr, "EN"), 'Maps showing the benthic fishing effort with the search area (red outline).')}
if (!is.null(outputListBenthicEffort$mapData)) {
