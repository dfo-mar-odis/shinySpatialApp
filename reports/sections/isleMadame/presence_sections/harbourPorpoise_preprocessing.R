...
pipelinePath <- paste0(githubRepo, "reports/sections/isleMadame/presence_sections/harbourPorpoise_preprocessing.R")
harbourPorpoise_rr$metadata <- read_google_metadata("Many", pipelinePath = pipelinePath)
