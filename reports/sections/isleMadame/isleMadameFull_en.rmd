...
### **Species presence polygons created by the Integrated Marine Response Planning (IMRP) team** {#speciesPresence-section}

The following section presents species presence polygons created by the Integrated Marine Response Planning (IMRP) team (formerly Planning for Integrated Environmental Response, PIER). For more information about how these polygons were created, please contact Adrian Hamer (<Adrian.Hamer@dfo-mpo.gc.ca>).
...
outputReport <- if (is.null(outputList$studyData)) {
  paste("* There are no relevant species presence records for this search area.")
} else {
  paste("* There are relevant species presence records for this search area.")
}
