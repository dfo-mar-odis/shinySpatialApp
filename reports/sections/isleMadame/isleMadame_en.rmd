...
#### *Area-specific `r imSection_rr$datasetName` results*
...
```{r {{imSection}}-region-plot, fig.height=7, fig.width=11, fig.cap=paste(write_caption_blurb(imSection_rr, "EN"), 'Map showing the search area defined by the user (red outline) used to query information from', imSection_rr$datasetName, 'records .')}
