...
```{r docks-region-plot, fig.height=7, fig.width=11, fig.cap=paste(write_caption_blurb(docks_rr, "EN"), 'Records of man-made solids within the Nova Scotia region defined by the user (red outline). Records were obtained from the Atlantic Shoreline Classification dataset in Open Data [@OpenData_docks]')}
if (!is.null(docksOutputList$studyData)) {
