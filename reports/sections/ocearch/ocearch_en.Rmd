...
# summary intro table
introResult <- !is.null(ocearchOutputList$studyData)
summaryIntroTable <- add_row_to_intro_summary(summaryIntroTable, name="[OCEARCH](#OCEARCH-section)", result=introResult)
