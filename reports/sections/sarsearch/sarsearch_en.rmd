...
```{r sarsearch-region-plot, fig.height=7, fig.width=11, fig.cap=paste(write_caption_blurb(sarsearch_rr, "EN"), 'Map showing the search area defined by the user (red outline) used to query information from Sarsearch records and all SAR search records present in the region. ')}
