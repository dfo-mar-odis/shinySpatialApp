...
Species data collected in the SAR search application (part of DFO's DMapps suite) was extracted and is presented below.
...
sarsearchReport <- if (is.null(outputList$studyData)) {
  "* There are no relevant Sarsearch records for this search area."
} else {
  "* There are relevant Sarsearch records for this search area."
}
