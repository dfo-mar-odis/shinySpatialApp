...
if (!is.null(DCSBoutput$regionData)){
  plot_rr_sf(regionMap, DCSBoutput$regionData, dcsb_rr$attribute, legendName= "Significant Benthic Areas", alpha = 0.6)
}
```
...
if(!is.null(DCSBoutput$studyData)){
  plot_rr_sf(areaMap, DCSBoutput$mapData, dcsb_rr$attribute, legendName= "Significant Benthic Areas", alpha = 0.6)
}
```
