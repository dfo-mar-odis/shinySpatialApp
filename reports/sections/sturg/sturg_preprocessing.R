...
if (globalControlEnv$updateGeoms) {
  sturgDatafile <- file.path(fileLoadPath, "/NaturalResources/Species/AtlanticSturgeon/sturgeon/Sturgeon_AOI_polygons.shp")
  ...
  mudPidDatafile <- file.path(fileLoadPath, "/NaturalResources/Species/AtlanticSturgeon/mudpiddock/Mudpiddock_CriticalHabitat_Polygons.shp")
